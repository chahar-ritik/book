...
directory. The file is a native executable produced by Rust, which you can run 
directly without needing the Rust toolchain. Because the default build is a 
debug build, Cargo puts the binary in a directory named _debug_. You can run 
